package com.csykes.allthesmallthings.screen;
...
public class DebarkerScreen extends ContainerScreen<DebarkerContainer> {
    ...
    private final ResourceLocation GUI = new ResourceLocation(AllTheSmallThings.MOD_ID, "textures/gui/debarker_screen.png");
