...
public class ChipperScreen extends AbstractContainerScreen<ChipperMenu> {
    private static final ResourceLocation background = new ResourceLocation(AllTheSmallThings.MOD_ID, "textures/gui/chipper_screen.png");

    public ChipperScreen(ChipperMenu p_97741_, Inventory p_97742_, Component p_97743_) {
